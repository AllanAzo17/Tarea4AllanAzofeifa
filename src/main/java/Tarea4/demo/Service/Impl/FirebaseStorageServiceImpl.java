...
import Tarea4.demo.Service.FirebaseStorageService;
import java.io.File;
...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
   ...
   public String cargaImagen(MultipartFile archivoLocalCliente, String carpeta, Long id) {
       try {
           ...
           //Se copia a Firestore y se obtien el url valido de la imagen )por 10 años)
   ...
   //Metodo utilitario para obtener un string con ceros....
