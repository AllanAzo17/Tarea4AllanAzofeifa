 ...
 */
package Tarea4.demo.Controller;

import Tarea4.demo.Domain.Categoria;
import Tarea4.demo.Service.CategoriaService;
...
public class PruebasController {
    ...
    // Controller tarea 4
    @PostMapping("/filtrar")
public String filtrarProductosPorParametros(@RequestParam(value = "idCategoria") Long idCategoria,
                                            ...
                                            Model model) {
    var productos = productoService.filtrarProductosPorIdCategoriaYPrecio(idCategoria, precioMin, precioMax, existenciasMin);
    model.addAttribute("productos", productos);
    model.addAttribute("totalProductos", productos.size());
